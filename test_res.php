...
{
    $sql = "SELECT ALLHISTORY.DATEBEGIN AS DATEBEGIN, ALLQUESTIONS.TEXT AS QTEXT, ALLANSWERS.TEXT AS ATEXT, ALLANSWERS.PRICE AS PRICE, ALLANSWERS.COMMENTARY AS COMMENTARY, ALLANSWERS.FACTOR as FACTOR, MODULE.TITLE AS MTITLE
